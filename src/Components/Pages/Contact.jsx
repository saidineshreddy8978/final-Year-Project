          ...
          <div className="row g-4">
            ...
            >
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <div className="ms-3">
                  ...
                  <p className="mb-0">SkillHigh,Andhra Pradesh</p>
                </div>
              </div>
              <div className="d-flex align-items-center mb-3">
                <div
                ...
                <div className="ms-3">
                  ...
                  <p className="mb-0">+91 7152725270</p>
                </div>
              </div>
              <div className="d-flex align-items-center">
                ...
                <div className="ms-3">
                  ...
                  <p className="mb-0">Gangalasaidineshreddy@gmail.com</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <iframe
                ...
                src="https://www.weather-forecast.com/locationmaps/Anantapur-1.8.gif"
                frameBorder={0}
